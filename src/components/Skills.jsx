...
export default function Skills() {
  ...
  return (
    <div
      id="skills"
      className="bg-gray-900 rounded-lg shadow-md flex items-center justify-center min-h-screen"
    >
      <div className="text-center max-w-2xl w-full mx-auto">
        <h2 className="text-4xl font-bold text-lightDesert mb-6">Skills</h2>
        <div className="grid grid-cols-4 gap-4 my-4 justify-items-center">
          {trail.map((props, index) => {
            ...
            return (
              <animated.div
                style={props}
                className="text-5xl text-goldDesert transition-all duration-300 transform hover:scale-110 hover:text-lightDesert"
                key={skills[index].id}
              >
                <Component />
              </animated.div>
